...
/// Interface to send frames/receive tracking from VR HMDs; OpenXR performs
/// substantially better vs. OpenVR/SteamVR
...
impl OpenXrService {
    ...
    /// - Load D3D extension; could be 11 or 12, depending on the user's
    ///   preference
    pub fn begin_init(d3d_version: D3DVersion) -> Result<(), CoreError> { todo!() }

    /// Runtime support optional, but it's nice to see debug output in the
    /// console
