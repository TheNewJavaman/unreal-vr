...
impl OpenXrService {
    ...
    pub fn begin_init(d3d_version: D3DVersion) -> Result<(), CoreError> {
        todo!()
    }

    /// Runtime support optional, but it's nice to see debug output in the console
    fn load_debug_ext() -> Result<(), CoreError> {
        todo!()
    }

    fn load_d3d11_ext() -> Result<(), CoreError> {
        todo!()
    }

    fn load_d3d12_ext() -> Result<(), CoreError> {
        todo!()
    }
    ...
    pub fn finish_init() -> Result<(), CoreError> {
        todo!()
    }

    fn create_session() -> Result<(), CoreError> {
        todo!()
    }

    fn enumerate_views() -> Result<(), CoreError> {
        todo!()
    }

    fn create_d3d_state() -> Result<(), CoreError> {
        todo!()
    }

    fn begin_session() -> Result<(), CoreError> {
        todo!()
    }

    fn store_proj_view_data() -> Result<(), CoreError> {
        todo!()
    }
}
