...
private static string UML_FORMAT = @"# An UnrealModLoader profile for {0} auto-generated by UnrealVR
[GameInfo]
...
IsUsingDeferedSpawn={4}";
        ...
        public async Task WriteUMLProfile()
        {
            ...
            var profilesDir = await installDir.CreateFolderAsync("Profiles", CreationCollisionOption.OpenIfExists);
            var profileFile = await profilesDir.CreateFileAsync(filename, CreationCollisionOption.OpenIfExists);
